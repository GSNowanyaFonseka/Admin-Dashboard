...
import { Calendar, Users, Clock, Book, FileText, RefreshCcw, Info } from 'lucide-react';
          ...
          <li>
            ...
            {updateInfoOpen && (
              <ul className="ml-6 mt-2 space-y-2">
                <li>
                  <button
                    onClick={() => setActivePage('update-lecturer')}
                    className={`w-full flex items-center p-2 rounded-lg ${
                      activePage === 'update-lecturer' ? 'bg-blue-100 text-blue-600' : 'hover:bg-gray-100'
                    }`}
                  >
                ...
                <li>
                  <button
                    onClick={() => setActivePage('update-student')}
                    className={`w-full flex items-center p-2 rounded-lg ${
                      activePage === 'update-student' ? 'bg-blue-100 text-blue-600' : 'hover:bg-gray-100'
                    }`}
                  >
                    Update Student Info
                  </button>
